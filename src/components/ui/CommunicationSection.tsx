          ...
          <ScrollAnimationWrapper animation="fade-up">
            <div className="bg-background border border-[var(--border-color)] p-10 hover:border-foreground transition-colors h-full">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-[var(--surface)] border border-[var(--border-color)] rounded-lg">
                  <initialResponse.icon className="w-6 h-6 text-[var(--accent)]" />
                </div>
              ...
              <div className="bg-[var(--surface)] border-l-2 border-[var(--accent)] p-6">
            ...
            <div className="bg-background border border-[var(--border-color)] p-10 hover:border-foreground transition-colors h-full">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                {channels.map((channel) => (
                  <div key={channel.name} className="flex flex-col items-center text-center gap-3 p-4 bg-[var(--surface)] border border-[var(--border-color)] rounded-lg group hover:border-[var(--accent)] transition-colors">
                    <channel.icon className="w-6 h-6 text-muted-foreground group-hover:text-[var(--accent)] transition-colors" />
        ...
        <StaggerChildren className="grid md:grid-cols-3 gap-8">
          {[projectCommunication, documentation, support].map((pillar) => (
            <StaggerItem key={pillar.title}>
              <div className="h-full bg-background border border-[var(--border-color)] p-10 hover:border-foreground transition-colors">
                <div className="flex items-center gap-4 mb-6">
                  <pillar.icon className="w-8 h-8 text-[var(--accent)]" />
