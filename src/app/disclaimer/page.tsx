...
export default function DisclaimerPage() {
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Disclaimer", url: "https://simpleinsolutions.com/disclaimer" }
  ]);
  const webPageSchema = generateWebPageSchema(
    "Disclaimer",
    "General disclaimer for SIMPLEIN Solutions website and services.",
    "https://simpleinsolutions.com/disclaimer"
  );
    ...
    <div className="bg-background min-h-screen pt-24 pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-foreground font-light leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 tracking-tight">2. No Professional Advice</h2>
            <p className="mb-4 text-muted-foreground text-[15px]">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 tracking-tight">3. Accuracy of Information</h2>
            <p className="mb-4 text-muted-foreground text-[15px]">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 tracking-tight">4. Third-Party Links</h2>
            <p className="mb-4 text-muted-foreground text-[15px]">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 tracking-tight">6. Contact</h2>
            <p className="mb-4 text-muted-foreground text-[15px]">
